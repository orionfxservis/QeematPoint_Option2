// Mobile menu toggle
    ...
    // Demo products data
    const products = [
      { name: 'Sugar 1kg / چینی 1کلو', category: 'grocery', city: 'Karachi', area: 'Gulshan-e-Iqbal', distanceKm: 1.2, price: 155 },
      { name: 'Sugar 1kg / چینی 1کلو', category: 'grocery', city: 'Karachi', area: 'Bahadurabad', distanceKm: 3.1, price: 150 },
      { name: 'Sugar 1kg / چینی 1کلو', category: 'grocery', city: 'Karachi', area: 'Nazimabad', distanceKm: 4.2, price: 148 },
      { name: 'Milk 1L Pack / دودھ 1لیٹر', category: 'grocery', city: 'Lahore', area: 'Model Town', distanceKm: 0.8, price: 235 },
      { name: 'Milk 1L Pack / دودھ 1لیٹر', category: 'grocery', city: 'Lahore', area: 'Johar Town', distanceKm: 2.4, price: 230 },
      { name: 'Tomato 1kg / ٹماٹر 1کلو', category: 'vegetables', city: 'Karachi', area: 'Saddar', distanceKm: 2.0, price: 95 },
      { name: 'Potato 1kg / آلو 1کلو', category: 'vegetables', city: 'Karachi', area: 'Gulshan-e-Iqbal', distanceKm: 1.2, price: 75 },
      { name: 'Chicken 1kg / چکن 1کلو', category: 'meat', city: 'Lahore', area: 'Township', distanceKm: 1.5, price: 495 },
      { name: 'Beef 1kg / بیف 1کلو', category: 'meat', city: 'Karachi', area: 'Liaquatabad', distanceKm: 3.7, price: 780 },
      { name: 'Cooking Oil 1L / کوکنگ آئل', category: 'grocery', city: 'Karachi', area: 'Defence', distanceKm: 5.2, price: 540 },
      ...
      { name: 'Shampoo 340ml / شیمپو', category: 'personal', city: 'Karachi', area: 'Gulistan-e-Johar', distanceKm: 2.8, price: 430 },
      { name: 'Washing Powder 2kg / واشنگ پاؤڈر', category: 'grocery', city: 'Lahore', area: 'DHA', distanceKm: 5.0, price: 880 }
    ];
    ...
    function renderProducts() {
      ...
      `).join('') || `
        <div class="px-3 py-4 text-center text-[0.75rem] text-slate-500">
          No items found for your search / ابھی اس تلاش کے لیے ڈیٹا موجود نہیں۔
        </div>
      `;
    }
    ...
    window.addEventListener('scroll', () => {
      ...
      if ((window.innerHeight + scrollY) >= document.body.offsetHeight - 50) {
        current = targetElements[targetElements.length - 1]?.getAttribute('id');
      }
